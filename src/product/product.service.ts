...
import { CategoryProductDocument } from 'src/category-product/entities/category-product.entity';
import {
  Category,
  CategoryDocument,
} from 'src/category/entities/category.entity';
import { Trend, TrendDocument } from 'src/trend/entities/trend.entity';
import {
  ValueProduct,
